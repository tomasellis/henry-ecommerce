                ...
                <div className = 'div_cont_product'>
                    ...
                    <div className="dropdown" >
                        ...
                        <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            <li><a className="dropdown-item" id='alto' href="#">PRECIO MAS ALTO</a></li>
                            <hr className = 'hr_filter_product'  />
                            <li><a className="dropdown-item" id='bajo' href="#">PRECIO MAS BAJO</a></li>
                        </ul>
                    </div>
                    <div className="dropdown" >
                        <button className="btn btn-ligth dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            <div className = 'div_size_filter_product'>
                                <li><button id = 'x'>X</button></li>
                                <li><button id = 's'>S</button></li>
                                <li><button id = 'm'>M</button></li>
                                <li><button id = 'l'>L</button></li>
                                <li><button id = 'xs'>XS</button></li>
                                <li><button id = 'xl'>XL</button></li>
                            </div>
                                <hr className = 'hr_filter_product' />
                        </ul>
                    </div>
                    <div className="dropdown" >
                        ...
                        <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                            <div className = 'div_colors_filter_product'>
                                <li><button className = 'color_filter color_one_filter' value = 'withe'> </button></li>
                                <li><button className = 'color_filter color_two_filter' value = 'black'></button></li>
                                <li><button className = 'color_filter color_three_filter' value = 'grey'></button></li>
                                <li><button className = 'color_filter color_four_filter' value = 'green'></button></li>
                                <li><button className = 'color_filter color_five_filter' value = 'yellow'></button></li>
                                <li><button className = 'color_filter color_six_filter' value = 'pink'></button></li>
                                <li><button className = 'color_filter color_seven_filter' value = 'sienna'></button></li>
                            </div>
                                <hr className = 'hr_filter_product' />
                        </ul>
                    </div>
