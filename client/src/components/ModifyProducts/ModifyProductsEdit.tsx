...
export default function RowEdit (props) {
  ...
  function handleNewOption () {
    if (newOption.color!=='' && newOption.size!==''  && newOption.stock !==''){
              ...
              {product.product_options.map((option) => (
                  <TableRow key={option.id}>
                    ...
                    <TextField
                      ...
                      onChange={(e)=> handleChangeProductOption(e,option.id)}
                    >
                    ...
                    <TableCell align="right">
                      ...
                      <button onClick={()=> handleDeleteOption(option.id)}>Out of Stock</button>
                    </TableCell>
                  </TableRow>
                ))}
                  ...
                  <TableRow key={option.id}>
                    <TableCell component="th" scope="row">
                       <TextField
                        ...
                        onChange={(e) =>handleChangeProductCategory (e,option.id)}
                       >
